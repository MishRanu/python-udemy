...
#adding the list box now
fileList = tkinter.Listbox(mainWindow)
fileList.grid(row=1, column=0, sticky="nsew", rowspan=2)
fileList.config(border=2, relief="sunken")

#now creating some code to populate the listbox
for zone in os.listdir("C:\Windows\System32"):
    fileList.insert(tkinter.END, zone)
#basically going to add the file name tkinter.END specify the item number where the insertion has to take place

#now adding the scroll bar
